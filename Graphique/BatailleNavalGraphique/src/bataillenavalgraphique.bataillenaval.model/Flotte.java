...
public abstract class Flotte implements Serializable{
    ...
    public abstract void impact(int xTire, int yTire, int numeroJoueur) throws InterruptedException;
   ...
   //***************************************************************************
    ...
    /**
     * Méthode qui permet de renvoyer la position dans la liste du navire.
     * Elle permet avec le numéro de référence de renvoyer la position dans la liste
     * @param lRef La lettre de référence.
     * @param nRef Le numéro de référence.
     * @return On retourne la position dans la liste.
     */
